...
class PadanKadPage extends StatefulWidget {
  const PadanKadPage({super.key});

  @override
  State<PadanKadPage> createState() => _PadanKadPageState();
}

class _PadanKadPageState extends State<PadanKadPage> {
  @override
  void initState() {
    super.initState();
    PermainanMusic().init();
